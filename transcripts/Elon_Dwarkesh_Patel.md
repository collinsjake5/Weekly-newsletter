...
channel: Dwarkesh Patel and Stripe
type: robotics
highlights:  Optimus and humanoid manufacturing, Tesla will use 10,000 to 30,000 Optimus robots for self-training, similar to FSD Elon Musk revealed Optimus's new strategy: creating an "Optimus Academy" with 10,000 to 30,000 real robots that will continuously perform various tasks in the real world 24/7, generating massive amounts of real-world data.  Simultaneously, Tesla will use its powerful physics simulation to run millions of virtual robots to accelerate iteration.  Ultimately, this "real-world self-play + large-scale simulation closed-loop" system will enable general artificial intelligence in robots.
---
